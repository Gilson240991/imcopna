	...
	<div class="container-fluid">
		...
		<form>
			<div class="row">
				...
				<div class="col-sm-12">
					<input type="text" name="txtBuscarParametros" placeholder="Realizar busqueda por Nombre, Descripcion" class="form-control">
				</div>
		...
		<div class="row">
			<div class="col-sm-2">
				<a href='' data-toggle='modal' data-target='#modalInsertarParametro' class="btn btn-success btn-block" >Agregar</a>
			</div>
		</div>
		<br>
		<div class="row">
						...
						<form  class="form-horizontal" id='form-persona-actualizar'>
							...
							<div style="margin-top:4px;">
								<div class="row">
									...
									<div class="col-sm-3">
										<input data-focus='true' type="text" name="nombre" id='nombre' value="" class="form-control">
									</div>
									<div class="col-sm-4">
		...
		<div class="modal fade" tabindex="-1" role="dialog" id="modalUpdateParametro">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form  class="form-horizontal" id='form-parametro-actualizar'>
