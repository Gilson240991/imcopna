...
function mostrarDatosDetalle(id){
    ...
    success:function(data){
      if(data.estado){
        ...
        $('#tb_detalle_parametro').append('<table class="table table-sm" id="table_detalle"><thead style="background-color:#212529;color:white;font-weight:bold"><tr><td style="width: 2% ">N°</td><td style="width: 6% ">Nombre</td><td style="width: 10% ">Descripción</td><td style="width: 5% ">Valor</td><td class="text-center" style="width: 2% ">Editar</td><td class="text-center" style="width: 2% ">Eliminar</td></tr></thead><tbody>')
